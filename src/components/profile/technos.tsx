...
const UnstyledTechnos: React.FC<TechnosProps> = props => {
    ...
    return (
        <div className={className}>
            ...
            <h3>Frontend</h3>
            <p>
                When working on frontend I mainly code with the <strong>react</strong>/<strong>typescript</strong> combo
                and its associated ecosystem (redux, jest, webpack, babel...). Initially got my hands on them around
                2015 moving away from AngularJs and ExtJs.
            </p>
            ...
            <p>
                ...
                procedures, architecture...). Had to deal with analytics and ecommerce for a while...
            </p>

            <h3>Architecture</h3>
            <p>
                In the recent years, I sensed the need to improve my knowledge of application architecture (DDD...),
                something that I always felt missing or too partially understood. A lifetime process...
            </p>
