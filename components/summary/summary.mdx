...
I'm also expert in SQL and relationship databases *(triggers, procedures, architecture...)*, at least something
that haven't changed so much along the years.

I usually share my time between architecture, frontend and backend (till now).
...
but really, I'm not a graphic designer *(although I designed this CV by myself)*.

I did have a long experience setting up infrastructure before the rise of the cloud, s3, docker, kubernetes,...
I simply could not follow, still I have pretty good skills with linux infra, scripting, compilation...

Haven't took he train of NoSQL database. Feared consistencies problems, but Mongo is on my personal roadmap.
